...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        init_decoder_hidden = torch.mm(last_hidden_cat, self.h_projection.weight.permute(1, 0))
        last_cell_cat = torch.cat((last_cell[0], last_cell[1]), 1)
        init_decoder_cell = torch.mm(last_cell_cat, self.c_projection.weight.permute(1, 0))
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        enc_hiddens_proj = enc_hiddens.matmul(self.att_projection.weight.permute(1,0))
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        V_t = torch.matmul(U_t, self.combined_output_projection.weight.permute(1,0))
