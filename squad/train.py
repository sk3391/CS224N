...
def main(args):
    ...
    # Get embeddings both Word and Character embeddings
...
#                  drop_prob=args.drop_prob)
    ...
    optimizer = optim.Adam(params = model.parameters(), lr = args.lr, betas = (args.beta1, args.beta2), eps = args.eps, weight_decay = args.l2_wd)
    ...
    while epoch != args.num_epochs:
        ...
        with torch.enable_grad(), \
            ...
            for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids in train_loader:
                ...
                loss = F.cross_entropy(log_p1, y1) + F.cross_entropy(log_p2, y2)
                loss_val = loss.item()
